...
;;(packages-require 'dired-x) ; provide extra commands for Dired
...
;; group Files
(packages-require 'ztree)
(global-set-key (kbd "C-c =") 'ztree-diff)
(global-set-key (kbd "C-c d") 'ztree-dir)
